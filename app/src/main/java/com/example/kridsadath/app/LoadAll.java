                    ...
                    for (i = 0; i < all.length(); i++) {
                        ...
                        for (j = 0; j < all_floor.length(); j++) {
                            ...
                            for (k = 0; k < all_room.length(); k++) {
                                ...
                                //Log.d(idR+" "+nameR+" "+detailR+" "+heightR+" "+isClose+" "+width+" "+depth+" "+range+" "+floorId,"checkLog");
                                db.addRoom(new room(Integer.valueOf(idR), nameR, detailR, Integer.valueOf(floorId)
                                        , String.valueOf(isClose), Double.valueOf(heightR), Integer.valueOf(width)
                                        , Integer.valueOf(depth), Integer.valueOf(range)));
